        ...
        {({ errors, touched }) => (
          <Form className="w-full">
            <div className="flex w-full flex-wrap lg:gap-0 justify-center boxanimated items-center">
              <Field
                type="tel"
                id="phoneNumber" // Unique ID for the field
                name="phoneNumber" // Name attribute for form submission and autofill support
                placeholder={t("EnterPhone")}
                onInput={(e) => {
                  e.target.value = e.target.value.replace(/\D/g, ""); // Removes non-digit characters
                }}
                ...
                autoComplete="tel" // Specific autocomplete attribute for phone number
              />
